...
import org.tv.ricrdsson.databinding.FragmentAddHostFinishBinding;
...
//                        .getWindowToken(), 0);
    ...
    public static void checkPVREnabledAndSetMenuItems(final Context context, Handler handler) {
        ...
        org.tv.ricrdsson.jsonrpc.method.Settings.GetSettingValue getSettingValue =
                new org.tv.ricrdsson.jsonrpc.method.Settings.GetSettingValue(org.tv.ricrdsson.jsonrpc.method.Settings.PVRMANAGER_ENABLED);
