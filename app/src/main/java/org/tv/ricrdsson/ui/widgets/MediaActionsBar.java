package org.tv.ricrdsson.ui.widgets;
...
import org.tv.ricrdsson.databinding.MediaActionsBarBinding;
...
import org.tv.ricrdsson.jsonrpc.method.Addons;
...
import org.tv.ricrdsson.ui.generic.GenericSelectDialog;
 ...
 * {@link org.tv.ricrdsson.host.HostConnectionObserver} and keeping itself updated when the state changes, but given
