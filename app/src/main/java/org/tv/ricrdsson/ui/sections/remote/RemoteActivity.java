 ...
 */
package org.tv.ricrdsson.ui.sections.remote;
...
import org.tv.ricrdsson.databinding.ActivityRemoteBinding;
import org.tv.ricrdsson.host.HostConnectionObserver;
import org.tv.ricrdsson.host.HostManager;
import org.tv.ricrdsson.jsonrpc.method.Application;
import org.tv.ricrdsson.jsonrpc.method.AudioLibrary;
import org.tv.ricrdsson.jsonrpc.method.GUI;
import org.tv.ricrdsson.jsonrpc.method.Input;
import org.tv.ricrdsson.jsonrpc.method.System;
import org.tv.ricrdsson.jsonrpc.method.VideoLibrary;
import org.tv.ricrdsson.jsonrpc.type.ListType;
import org.tv.ricrdsson.jsonrpc.type.PlayerType;
import org.tv.ricrdsson.service.MediaSessionService;
import org.tv.ricrdsson.ui.BaseActivity;
import org.tv.ricrdsson.ui.generic.NavigationDrawerFragment;
import org.tv.ricrdsson.ui.generic.SendTextDialogFragment;
import org.tv.ricrdsson.ui.generic.VolumeControllerDialogFragmentListener;
import org.tv.ricrdsson.ui.sections.hosts.AddHostActivity;
import org.tv.ricrdsson.utils.LogUtils;
import org.tv.ricrdsson.utils.TabsAdapter;
import org.tv.ricrdsson.utils.UIUtils;
...
//                Input.ExecuteAction actionSetFullscreen = new Input.ExecuteAction(Input.ExecuteAction.TOGGLEFULLSCREEN);
    ...
    @Override
    public void onPlayerPropertyChanged(org.tv.ricrdsson.jsonrpc.notification.Player.NotificationsData notificationsData) {}
