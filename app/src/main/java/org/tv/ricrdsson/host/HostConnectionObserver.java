 ...
 */
package org.tv.ricrdsson.host;

import android.os.Handler;
import android.os.Looper;

import org.tv.ricrdsson.host.actions.GetPlaylist;
import org.tv.ricrdsson.jsonrpc.ApiCallback;
import org.tv.ricrdsson.jsonrpc.method.JSONRPC;
import org.tv.ricrdsson.jsonrpc.method.Player;
import org.tv.ricrdsson.jsonrpc.notification.Application;
import org.tv.ricrdsson.jsonrpc.notification.Input;
import org.tv.ricrdsson.jsonrpc.notification.Player.NotificationsData;
import org.tv.ricrdsson.jsonrpc.notification.Playlist;
import org.tv.ricrdsson.jsonrpc.notification.System;
import org.tv.ricrdsson.jsonrpc.type.ApplicationType;
import org.tv.ricrdsson.jsonrpc.type.ListType;
import org.tv.ricrdsson.jsonrpc.type.PlayerType;
import org.tv.ricrdsson.utils.LogUtils;
...
public class HostConnectionObserver
    ...
    public interface PlayerEventsObserver {
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link org.tv.ricrdsson.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link org.tv.ricrdsson.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently playing item, obtained by a call to {@link org.tv.ricrdsson.jsonrpc.method.Player.GetItem}
         */
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link org.tv.ricrdsson.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link org.tv.ricrdsson.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently paused item, obtained by a call to {@link org.tv.ricrdsson.jsonrpc.method.Player.GetItem}
         */
    ...
    @Override
    public void onPropertyChanged(org.tv.ricrdsson.jsonrpc.notification.Player.OnPropertyChanged notification) {
     ...
     */
    public void onPlay(org.tv.ricrdsson.jsonrpc.notification.Player.OnPlay notification) {
    ...
    public void onResume(org.tv.ricrdsson.jsonrpc.notification.Player.OnResume notification) {
        checkWhatsPlaying();
    }

    public void onPause(org.tv.ricrdsson.jsonrpc.notification.Player.OnPause notification) {
        checkWhatsPlaying();
    }

    public void onSpeedChanged(org.tv.ricrdsson.jsonrpc.notification.Player.OnSpeedChanged notification) {
        checkWhatsPlaying();
    }

    public void onSeek(org.tv.ricrdsson.jsonrpc.notification.Player.OnSeek notification) {
        checkWhatsPlaying();
    }

    public void onStop(org.tv.ricrdsson.jsonrpc.notification.Player.OnStop notification) {
    ...
    public void onAVStart(org.tv.ricrdsson.jsonrpc.notification.Player.OnAVStart notification) {
        checkWhatsPlaying();
    }

    public void onAVChange(org.tv.ricrdsson.jsonrpc.notification.Player.OnAVChange notification) {
    ...
    private void getApplicationProperties() {
        org.tv.ricrdsson.jsonrpc.method.Application.GetProperties getProperties =
                new org.tv.ricrdsson.jsonrpc.method.Application.GetProperties(org.tv.ricrdsson.jsonrpc.method.Application.GetProperties.VOLUME,
                                                                           org.tv.ricrdsson.jsonrpc.method.Application.GetProperties.MUTED);
