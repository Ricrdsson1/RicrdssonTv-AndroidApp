...
package org.tv.ricrdsson.tests.ui.addons;
...
import static org.tv.ricrdsson.testhelpers.EspressoTestUtils.clickRecyclerViewItem;
 ...
 * This is never send as the {@link org.tv.ricrdsson.testutils.tcpserver.handlers.AddonsHandler} is
 * added in {@link super#setUp()} which is never started by Espresso as it waits for
 * {@link org.tv.ricrdsson.ui.sections.addon.AddonsActivity} to become idle.
 */
