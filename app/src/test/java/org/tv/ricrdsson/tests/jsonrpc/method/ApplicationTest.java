...
package org.tv.ricrdsson.tests.jsonrpc.method;
...
import org.tv.ricrdsson.host.HostConnection;
import org.tv.ricrdsson.jsonrpc.type.ApplicationType;
import org.tv.ricrdsson.jsonrpc.type.GlobalType;
import org.tv.ricrdsson.testutils.tcpserver.MockTcpServer;
import org.tv.ricrdsson.testutils.tcpserver.handlers.ApplicationHandler;
import org.tv.ricrdsson.testutils.tcpserver.handlers.JSONConnectionHandlerManager;
import org.tv.ricrdsson.utils.RoboThreadRunner;
...
public class ApplicationTest {
    ...
    public void getPropertiesTest() throws Exception {
        org.tv.ricrdsson.jsonrpc.method.Application.GetProperties properties =
                new org.tv.ricrdsson.jsonrpc.method.Application.GetProperties(org.tv.ricrdsson.jsonrpc.method.Application.GetProperties.MUTED);
    ...
    public void incrementVolumeTest() throws Exception {
        org.tv.ricrdsson.jsonrpc.method.Application.SetVolume setVolume =
                new org.tv.ricrdsson.jsonrpc.method.Application.SetVolume(GlobalType.IncrementDecrement.INCREMENT);
    ...
    public void decrementVolumeTest() throws Exception {
        org.tv.ricrdsson.jsonrpc.method.Application.SetVolume setVolume =
                new org.tv.ricrdsson.jsonrpc.method.Application.SetVolume(GlobalType.IncrementDecrement.DECREMENT);
        applicationHandler.setVolume(77, false);
        setVolume.execute(hostConnection, new ApiCallback<Integer>() {
            @Override
            public void onSuccess(Integer result) {
    ...
    public void setVolumeTest() throws Exception {
        org.tv.ricrdsson.jsonrpc.method.Application.SetVolume setVolume =
                new org.tv.ricrdsson.jsonrpc.method.Application.SetVolume(83);
        applicationHandler.setVolume(77, false);
        setVolume.execute(hostConnection, new ApiCallback<Integer>() {
            @Override
            public void onSuccess(Integer result) {
    ...
    private void sendSetMute(final boolean expectedMuteState) throws InterruptedException {
        org.tv.ricrdsson.jsonrpc.method.Application.SetMute mute =
                new org.tv.ricrdsson.jsonrpc.method.Application.SetMute();
